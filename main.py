...
if __name__ == '__main__':
    ...
    cv.createTrackbar('threshold', 'window', 150, 255, on_trackbar)
    while True:
        ...
        # resizing for 28x28
        resized_frame = cv.resize(threshold_frame, (28, 28), interpolation=cv.INTER_AREA)
        ...
        cv.putText(threshold_frame, str(np.argmax(prediction)), (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 2, (255, 255, 255), 3)
        cv.imshow('window', threshold_frame)
